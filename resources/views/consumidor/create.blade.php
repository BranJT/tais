        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    Consumidores<a href="/empresa/{{$empresa_id}}/consumidor/" style="float:right;">Volver</a>
                </div>
                <div class="panel-body">
                    Añadir una nuevo consumidor          
                </div>
                <div class="well">
				{!! Form::open(['action' => ['ConsumidorController@store',$empresa_id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="form-group">
                        {{Form::label('ruc', 'RUC')}}
                        {{Form::number('ruc', '',['class' => 'form-control', 'placeholder' => 'RUC'])}}
                    </div>
			        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {{Form::number('nivel', '',['class' => 'nivel_consumidor', 'placeholder' => 'Nivel'])}}
                    </div>
                    <div class="form-group">
