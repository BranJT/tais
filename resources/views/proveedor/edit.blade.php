        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    Proveedores
                    <a href="/empresa/{{$empresa_id}}/proveedor/" style="float:right;">Volver</a>
                </div>
                <div class="panel-body">
                    Editar una proveedor          
                </div>
                <div class="well">
				{!! Form::open(['action' => ['ProveedorController@update', $proveedor->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {{Form::number('nivel', $proveedor->nivel,['class' => 'nivel_proveedor', 'placeholder' => 'Nivel'])}}
                    </div>
                    <div class="form-group">
