        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    Editar mapa de Procesos
                </div>
                <div class="well">
				{!! Form::open(['action' => ['MapaController@update',$mapa->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
			    	<div class="form-group">
			    		{{Form::label('nombre', 'Nombre')}}
			    		{{Form::text('nombre', $mapa->nombre,['class' => 'form-control', 'placeholder' => 'Nombre'])}}
			    	</div>

                    <div class="form-group">
                        {{Form::label('entrada', 'Entradas del mapa')}}
                        {{Form::text('entrada', $mapa->entrada,['class' => 'form-control', 'placeholder' => 'Nombre'])}}
                    </div>

                    <div class="form-group">
                        {{Form::label('salida', 'Salidas del Mapa')}}
                        {{Form::text('salida', $mapa->salida,['class' => 'form-control', 'placeholder' => 'Nombre'])}}
                    </div>
